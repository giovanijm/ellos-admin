@if (Session::has('messageInfo'))
    <div id="toastMessage-Info" class="flex items-center p-4 mb-4 mt-2 lg:mt-0 text-blue-800 border-l-4 border-blue-300 bg-blue-50 rounded-lg shadow-lg" role="alert">
...
@elseif (Session::has('messageSuccess'))
    <div id="toastMessage-Info" class="flex items-center p-4 mb-4 mt-2 lg:mt-0 text-green-800 border-l-4 border-green-400 bg-green-100 rounded-lg shadow-lg" role="alert">
...
@elseif (Session::has('messageWarning'))
    <div id="toastMessage-Info" class="flex items-center p-4 mb-4 mt-2 lg:mt-0 text-yellow-800 border-l-4 border-yellow-400 bg-yellow-100 rounded-lg shadow-lg" role="alert">
...
@elseif (Session::has('messageDanger'))
    <div id="toastMessage-Info" class="flex items-center p-4 mb-4 mt-2 lg:mt-0 text-red-800 border-l-4 border-red-400 bg-red-100 rounded-lg shadow-lg" role="alert">
