<div class="justify-end p-2 bg-gray-100 border rounded-lg hidden lg:flex">
    <div data-dial-init class="flex right-6 bottom-6 group">
        ...
        <button type="button" data-dial-toggle="speed-dial-menu-horizontal" aria-controls="speed-dial-menu-horizontal" aria-expanded="false" class="flex items-center justify-center text-white bg-blue-700 rounded-lg w-12 h-12 shadow-sm hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
            ...
            <span class="sr-only">Abrir as ações do menu</span>
        </button>
    </div>
</div>
