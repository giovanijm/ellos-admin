@php
    ...
    $moduleCustomers = new Permission(); $moduleCustomers->name = "moduleCustomers";
@endphp
...
>
    ...
    <x-admin.layouts-v2.nav-modulo label="Módulo">
        ...
        @can('view', $moduleCustomers)
            ...
            >
                <x-fas-people-group class="icon-item" />
                <span class="ml-2">{{ __('Clientes') }}</span>
            </x-admin.layouts-v2.nav-modulo-item>
        @endcan
