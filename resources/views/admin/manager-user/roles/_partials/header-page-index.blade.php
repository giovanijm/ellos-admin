<div class="lg:grid lg:grid-cols-3 gap-2 lg:gap-4">
    <div class="flex items-center">
        ...
        <div class="flex flex-col ml-2">
            ...
            <span class="font-bold text-normal text-sm sm:text-xl xl:text-2xl  text-gray-900 uppercase drop-shadow">
    ...
    <div class="lg:col-span-2">
        <form class="" method="GET">
            <div class="lg:flex lg:gap-2">
                <ul class="items-center text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg grid grid-cols-2 sm:flex my-2 uppercase">
                ...
                <div class="flex items-center w-full my-2 lg:mx-2">
                    ...
                    <a href="{{ route('admin.roles.index') }}">
                        <button type="button" class="p-2.5 ml-2 text-sm font-medium text-white shadow bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    @can('new', $objPermissions)
                        <a href="{{ route('admin.roles.create') }}">
                            <button type="button" class="p-2.5 ml-2 text-sm font-medium text-white shadow bg-green-600 rounded-lg border border-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
