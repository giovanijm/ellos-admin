            ...
            <form id="formExcluir" method="POST" action="">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-400">
                        Deseja excluír o registro <span id="lblMemsagemExclusao">1</span> ?
                    </h3>
                    <x-danger-button type="submit" icon="codicon-trash">
                        Sim, quero excluir
                    </x-danger-button>
                    <x-secondary-button id="btnRecusarModal" type="button" class="w-full lg:w-auto" icon="clarity-cancel-line">
                        Não, cancelar
                    </x-secondary-button>
                </div>
            </form>
