<div id="modal-permissions" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[70] overflow-visible">
...
{{-- <div id="modalE2" tabindex="-1" class="fixed top-0 left-0 right-0 z-[70] overflow-visible hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
