<div class="ellos-header-page">
    <div class="div-titulo">
        ...
        <div class="div-text">
            <span class="subtitulo">@lang('admin/permissions.labelManagerUsers')</span>
            <span class="titulo">
                ...
                <ul>
                    ...
                    <li>
                        <div class="opcao">
                            ...
                            <label for="filter_row_name">{{ __('Nome') }}</label>
                        </div>
                    </li>
                    <li>
                        <div class="opcao">
                            <input @if($filter_row == 'description') checked @endif id="filter_row_description" type="radio" value="description" name="filter_row">
                            <label for="filter_row_description">{{ __('Descrição') }}</label>
                        </div>
                    </li>
                </ul>
                <div class="div-busca">
