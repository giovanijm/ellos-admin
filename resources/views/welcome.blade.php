...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Sistema Ellos') }}</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div>
                    <h1 class="text-lg text-gray-300 font-extrabold">@lang('messages.welcome')</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400 text-sm">@lang('messages.example_multilanguage_laravel')</p>
                </div>
            </div>
        </div>
    </body>
